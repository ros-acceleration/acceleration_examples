...
def barplot_all(image_pipeline_msg_sets):
    global target_chain
...
######################
# image_pipeline_msg_sets = msgsets_from_trace(str(os.environ["HOME"]) + "/.ros/tracing/trace_resize")
...
#####################
image_pipeline_msg_sets = msgsets_from_trace(str(os.environ["HOME"]) + "/.ros/tracing/trace_resize")
barplot_all(image_pipeline_msg_sets)

# image_pipeline_msg_sets = msgsets_from_trace(str(os.environ["HOME"]) + "/.ros/tracing/trace_resize_stress")
# barplot_all(image_pipeline_msg_sets)

# ## corrupted data
# image_pipeline_msg_sets = msgsets_from_trace(str(os.environ["HOME"]) + "/.ros/tracing/trace_resize_fpga")
# barplot_all(image_pipeline_msg_sets)

# image_pipeline_msg_sets = msgsets_from_trace(str(os.environ["HOME"]) + "/.ros/tracing/trace_resize_fpga_stress")
# barplot_all(image_pipeline_msg_sets)
...
# image_pipeline_msg_sets_cpu = msgsets_from_trace(str(os.environ["HOME"]) + "/.ros/tracing/trace_resize_stress")
# image_pipeline_msg_sets_ns_cpu = barchart_data(image_pipeline_msg_sets_cpu)

# image_pipeline_msg_sets_fpga = msgsets_from_trace(str(os.environ["HOME"]) + "/.ros/tracing/trace_resize_fpga_stress")
# image_pipeline_msg_sets_ns_fpga = barchart_data(image_pipeline_msg_sets_fpga)

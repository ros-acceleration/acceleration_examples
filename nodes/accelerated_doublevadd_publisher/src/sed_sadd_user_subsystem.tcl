...
proc build_kernel {} {
  ...
  set init_dir [pwd]
  # cd $v_subsystem_ip_path_user/oneapi_sadd/sadd 
  ...
  # exec python add_fpga_ip_export_1_di_hw_tcl_adjustment_script.py

  cd $v_kernel_name.fpga_ip_export.prj_1
  exec python ${v_kernel_name}_fpga_ip_export_1_di_hw_tcl_adjustment_script.py
...
proc create_custom_subsystem {} {
  ...
  add_instance  sadd_kernel                 add_fpga_ip_export_1_di
  ...
  add_connection  cpu_clk_bridge.out_clk    sadd_kernel.clock

  # This 2x clock output is removed from the generated IP by oneAPI-IP-Authoring flow starting from 2023.1
  add_connection  cpu_clk_bridge.out_clk    sadd_kernel.clock2x 
  
  add_connection  cpu_rst_bridge.reset_out   cpu_mm_bridge.reset

  add_connection  cpu_rst_bridge.reset_out   sadd_kernel.resetn

  add_connection  cpu_mm_bridge.m0           sadd_kernel.csr_ring_root_avs
  ...
  set_interface_property  ${v_instance_name}_device_exception_bus      export_of   sadd_kernel.device_exception_bus

  add_interface           ${v_instance_name}_kernel_irqs      conduit     end
  set_interface_property  ${v_instance_name}_kernel_irqs      export_of   sadd_kernel.kernel_irqs

  set_connection_parameter_value    cpu_mm_bridge.m0/sadd_kernel.csr_ring_root_avs	  	baseAddress "0x00004000"
